...
export default function UserScreen({navigation}) {
    ...
    if (tenSanPham === "") {
      ...
      if (giaSanPham === '') {
        ...
        if (isNaN(giaSanPham) == false) {
          ...
          fetch('http://192.168.1.17:3000/addProduc/', {
            method: 'POST',
            headers: {
  ...
  const suaSanPham = () => {
    ...
    fetch('http://192.168.1.17:3000/updateProduc/', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
  ...
  const getData = async () => {
    try {
      const response = await fetch('http://192.168.1.17:3000/trang/' + pageNumber);
  ...
  const xoaSanPham = (id) => {
    ...
    fetch('http://192.168.1.17:3000/deleteProduc/', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
